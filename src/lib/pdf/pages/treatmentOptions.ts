...
export const addTreatmentOptionsPages = ({ doc }: PdfPageProps) => {
    ...
    doc.setFontSize(13);
    doc.setFont('helvetica', 'bold');
    doc.text('How is the treatment delivered?', margin, 35);
    ...
    doc.setFontSize(13);
    doc.setFont('helvetica', 'bold');
    doc.text('What does the follow-up involve?', margin, 35);
