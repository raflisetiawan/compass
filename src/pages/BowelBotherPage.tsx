              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center">
                    <CardTitle className="text-2xl font-bold">
                      Bother with bowel function at 1 year
                    </CardTitle>
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <CardContent>
                  <p className="text-sm text-gray-600 mb-4">
                    ...
                    of bother with their bowel function as you. The icon plot
                    shows how the degree of their bowel bother changes at 1 year
                    from starting their prostate cancer treatment.
                  </p>

                  <div className="border-2 border-blue-200 rounded-lg p-4 mb-6">
                    <h3 className="font-bold mb-2 text-lg">
                      Your current bowel bother status:
                    </h3>
                    <div className="flex items-center bg-pink-100 p-2 rounded">
                      ...
                      <span className="ml-2">
                        {answers.bowel_bother || "Not a problem"}
                      </span>
                    </div>
                  </div>
